...
> Design notes for **realtime-fintech-notify** — a runnable go example that Go service for risk-aware realtime payment notifications.
...
- **Feature code** — the actual task: payment alerts.
